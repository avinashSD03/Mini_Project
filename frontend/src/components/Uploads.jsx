    ...
    return (
        <div className="flex min-h-screen w-screen w-full bg-gray-300">
            ...
            <div class="flex h-full w-full flex-col">
                ...
                <Header usn={usn} />
                <main id="dashboard-main" class="md:h-[calc(100vh-10rem)] md:ml-[calc(100vh-26rem)] md:mt-[calc(100vh-38rem)] sm:h-[calc(100vh-10rem)] sm:ml-[calc(100vh-42rem)] sm:mt-[calc(100vh-36rem)] overflow-auto px-4 py-10">
                    ...
                    <form onSubmit={handleSubmit} className="relative mt-3 flex flex-col px-60 pb-10" autoComplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <input className="!block w-full cursor-text appearance-none rounded-md border bg-gradient-to-l from-slate-800 to-violet-900 text-white border-gray-400 py-2 px-3 text-sm outline-none"
                                type="number" min='1' max='8' id="email" placeholder="Semester" onChange={handleChange} name="sem" value={newNotes.sem} required />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input className="block w-full cursor-text appearance-none rounded-md border bg-gradient-to-l from-slate-800 to-violet-900 text-white border-gray-400 py-2 px-3 text-sm outline-none"
                                type="number" min='1' max='5' id="email" placeholder="Unit" onChange={handleChange} name="unit" value={newNotes.unit} required />
                        </div>
